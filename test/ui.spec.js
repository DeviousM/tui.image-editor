...
describe("UI", () => {
    ...
    describe("_makeSubMenu()", () => {
        it("MakeMenuElement should be executed for the number of menus specified in the option.", () => {
            ...
            ui._makeSubMenu();
            expect(ui._makeMenuElement.calls.count()).toBe(
                uiOptions.menu.length
            );
        });
        ...
        it("Instance of the menu specified in the option must be created.", () => {
            ...
            snippet.forEach(uiOptions.menu, menuName => {
                const constructorNameOfInstance = getConstructorName(
                    ui[menuName].constructor
                );
                const expected = menuName.replace(/^[a-z]/, $0 =>
                    $0.toUpperCase()
                );
    ...
    describe("initCanvas()", () => {
        ...
        beforeEach(() => {
            ...
            ui._actions.main = {
                initLoadImage: jasmine
                    .createSpy("initLoadImage")
